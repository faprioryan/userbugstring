...
async def bot_support(wannahelp):
    ...
    await wannahelp.edit(
        "Join the Channel: @userbotindocloud \
        \nJoin the Chat: @userbotindo")


@register(outgoing=True, pattern="^.creator$")
async def creator(e):
    await e.edit("[Userbo Indonesia Users](https://t.me/userbotindo)")
...
async def reedme(e):
    await e.edit(
        ...
        "\n[OpenUserBot's README.md file](https://github.com/userbotindo/userbug/blob/stable/README.md)"
        "\n[Setup Guide - Basic](https://google.com/)"
        "\n[Setup Guide - Google Drive](https://google.com/)"
        "\n[Setup Guide - LastFM Module](https://google.com/)"
        "\n[Video Tutorial - 576p](https://google.com/)"
        "\n[Video Tutorial - 1080p](https://google.com/)"
        "\n[Special - Note](https://google.com/)")
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        "Click [here](https://github.com/userbotindo/userbug) to open Userbug GitHub page."
    )
